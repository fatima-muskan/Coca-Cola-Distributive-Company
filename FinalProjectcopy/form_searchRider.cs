...
{
    public partial class form_searchRider : Form
    {
        RiderDL BST = new RiderDL();
        public form_searchRider()
        {
            InitializeComponent();
        }
        ...
        private void form_searchRider_Load(object sender, EventArgs e)
        {
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            if (txtBox_Id.Text != "")
            {
                ...
                RiderBL emp = BST.search(int.Parse(txtBox_Id.Text));
                if (emp != null)
                {
